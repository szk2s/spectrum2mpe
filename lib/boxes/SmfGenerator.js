...
class SmfGenerator {
    constructor(initInfo){
        this.ppqr = initInfo.config.ppqr;
        this.pitchBendRange = initInfo.config.pitchBendRange;
        this.defaultVelocity = initInfo.config.defaultVelocity;
    ...
    process(data){
        return new Promise((resolve, reject) => {
            ...
            let startChannel;let endChannel;
            ...
            for (let i = startChannel - 1; i < endChannel; i++){
