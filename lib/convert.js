...
const convertFromSpear = ( inputFilePath, _option = {outputDirName: path.dirname(inputFilePath), makeOutputFolder: true, outputFolderName: 'output'} ) => new Promise( async (resolve, reject) => {
    const defaultOption = {
