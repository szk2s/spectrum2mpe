...
describe('genSMFs', function() {
  it('should return an array of smfs', async function() {
...
describe('smfExport', function() {
  it('should export midi file', async function() {
    const outputFilePath =
      __dirname + '/output/exported-by-smfExport-function.mid';
...
describe('Convert', function() {
  it('should export midi file', async function() {
    ...
    const filetype = mime.lookup(
      __dirname +
        '/output/exported-with-convertFromSpear-function/large_bowl.mid'
    );
    assert.equal(filetype, 'audio/midi');
  });
});
